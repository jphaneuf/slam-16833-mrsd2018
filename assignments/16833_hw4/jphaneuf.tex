...
After all frames were processed, the fused point cloud contained 920309 points yielding a compression ratio of \11.52 % . In this case, the low ratio shows that many input points were effectively merged with the map, and not just blindly appended, creating a map that is so fresh, so clean.
